package com.fsadev.pizzabuilder.game.asteroid.data.drawer;
...
import com.fsadev.pizzabuilder.game.asteroid.data.DrawerData;
import com.fsadev.pizzabuilder.game.asteroid.data.ParticleData;
...
public class AsteroidDrawer extends DrawerData {
    ...
    private final Bitmap asteroidBitmap3;
    private final Bitmap asteroidBitmap4;
    private final Bitmap asteroidBitmap5;
    ...
    public AsteroidDrawer(Context context, int colorAccent, int colorPrimary, Paint asteroidPaint, Paint particlePaint) {
        ...
        //Crea los bitmap de cada asteroide
        asteroidBitmap = ImageUtils.gradientBitmap(ImageUtils.getVectorBitmap(context, R.drawable.ic_cheesee), colorAccent, colorPrimary);
        asteroidBitmap2 = ImageUtils.gradientBitmap(ImageUtils.getVectorBitmap(context, R.drawable.ic_tomato), Color.RED, colorPrimary);
        asteroidBitmap3 = ImageUtils.gradientBitmap(ImageUtils.getVectorBitmap(context, R.drawable.ic_mushroom), Color.YELLOW, Color.WHITE);
        asteroidBitmap4 = ImageUtils.gradientBitmap(ImageUtils.getVectorBitmap(context, R.drawable.ic_bell_pepper), Color.GREEN, Color.YELLOW);
        asteroidBitmap5 = ImageUtils.gradientBitmap(ImageUtils.getVectorBitmap(context, R.drawable.ic_egg), colorAccent, colorPrimary);
    }
    ...
    public void makeNew() {
        ...
        switch (randomNum){
            case 1:
                ...
                break;
            case 2:
                asteroids.add(new AsteroidData(asteroidBitmap2));
                break;
            case 3:
                asteroids.add(new AsteroidData(asteroidBitmap3));
                break;
            case 4:
                asteroids.add(new AsteroidData(asteroidBitmap4));
                break;
            case 5:
                asteroids.add(new AsteroidData(asteroidBitmap5));
                break;
        }
    }
