...
public class ToppingsAdapter extends RecyclerView.Adapter<ToppingsAdapter.ViewHolder>{
    ...
    public ToppingsAdapter(ArrayList<Ingredient> list){
    ...
    @NonNull
    @Override
    public ToppingsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ToppingsAdapter.ViewHolder holder, int position) {
        //cambia el nombre por el del ingrediente
        holder.checkBox.setText(listIngredients.get(position).getNombre());
        //maneja la disponibilidad, si es falso desactiva el radiobutton
        holder.checkBox.setEnabled(listIngredients.get(position).getDisponibilidad());
        //maneja el check
        holder.checkBox.setChecked(listIngredients.get(position).isChecked());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            checkBox = itemView.findViewById(R.id.item_topping_check);
